(defpackage :bitsch
(:use "COMMON-LISP" "OM" "CL-USER" :cl-user :cl :cffi))
...
(cffi::defcfun ("create_new_problem" new-problem) :pointer
    ...
    (cantus-firmus :string) ; a string containing the midicents values of the cantus firmus
    (species :int) ; an integer representing the wished species
